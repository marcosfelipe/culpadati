...
class Admin::UsersControllerTest < ActionController::TestCase
  ...
  test "should create admin_user" do
    assert_difference('Admin::User.count') do
      post :create, admin_user: { crypted_password: @admin_user.crypted_password, email: @admin_user.email, salt: @admin_user.salt }
    end
  ...
  test "should update admin_user" do
    patch :update, id: @admin_user, admin_user: { crypted_password: @admin_user.crypted_password, email: @admin_user.email, salt: @admin_user.salt }
    assert_redirected_to admin_user_path(assigns(:admin_user))
  end
